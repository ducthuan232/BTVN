...
public class Bai63 {
    public static void NongDoCon(){
        ...
        double W=0;
        if(donvi.equals("kg")){ W=can*0.2046;}
        else if(donvi.equals("pound")){ W=can;};
        double r=0;
        System.out.println("Nhập giới tính: ");
        String gioitinh=sc.next();
        if(gioitinh.equals("nam")){r=0.73;}
        else if(gioitinh.equals("nu")){r=0.66;}
        ...
        double gioihan=0;
        if(quocgia.equals("VietNam")||quocgia.equals("Anh")){gioihan=0.08;}
        else if(quocgia.equals("TrungQuoc")||quocgia.equals("Phap")){gioihan=0.09;}
        else if(quocgia.equals("My")||quocgia.equals("Uc")){gioihan=0.07;}
        System.out.println("chỉ số BAC: "+BAC);
        if(BAC<gioihan){System.out.println("được phép lái xe");}
        else{System.out.println("không được phép lái xe");}
